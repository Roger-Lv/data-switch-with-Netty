...
import org.bdware.sw.handler.ClientForSwitchWithoutPoolHandler;

import java.net.InetSocketAddress;

public class ClientForSwitchWithoutPool {
    static Logger logger = LogManager.getLogger(MockUserClient.class);
    public ClientForSwitchWithoutPool() {
                    ...
                    .handler(new ChannelInitializer<SocketChannel>()//进行通道初始化配置
                    {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception
                        {
                            socketChannel.pipeline().addLast(new LengthFieldBasedFrameDecoder(maxFrame,
                                    ...
                                    .addLast(new ClientForSwitchWithoutPoolHandler(callback));//添加我们自定义的Handler
//
                        }
                    });
